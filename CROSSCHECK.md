...
3. если переданы все аргументы или не передан только `-i, --input`, приложение читает из файла/process.stdin и записывает в файл зашифрованный/расшифрованный текст, при этом предыдущие записи не удаляются
